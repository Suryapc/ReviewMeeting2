       ...
       validateField(name,value){
        ...
        switch(name){
          case "emailAddress":
           ...
           case "password":
            // passwordValid = value.match(/^(?=.*[0-9])(?=.*[!@#$%^&*]) [a-zA-Z0-9!@#$%^&*] {7,15}$/);
      ...
      render(){
          return(
             <div className='firstHalf '>
                 <h1 className='text-primary ms-5 mt-5' id="web"><u>Form Validation</u></h1>
                    ...
                    <div className='form-group ms-5 mt-5'>
                        <div className='row'>
                          ...
                          <div className='col-6'>
                             <input type="text" name="emailAddress" className='form-control'
                              placeholder='eg:,john@gmail.com' value={this.state.emailAddress} 
                        ...
                        <div className='row'>
                          ...
                          <div className='col-6'>
                              <input type="password" name="password" className='form-control mt-2'
                               placeholder='abcde1234' value={this.state.password} 
                               onChange={this.handleUserInput} required/>
                           </div>
                        </div>
                        ...
                        <div className='row'>
                         ...
                         <div className='col-6 offset-4'>
                              <input type="submit" name="submit" className='btn btn-primary mt-5 w-25 '
